...
Knot is a Highly Available, Secure and Reliable DNS Server. It provides features like Web Dashboard, REST API, Load Balancing, DNS Notify, Dynamic Update, Split DNS, IPv6, and more.
...
In order to deploy knot, Please follow this [guide](Deployment.md).


## Architecture

For more in depth explaination how knot single-node and multi-nodes (cluster) setup works, Please check this [document](Architecture.md).
